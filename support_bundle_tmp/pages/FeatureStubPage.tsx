...
const FeatureStubPage: React.FC<Props> = ({ title, enabled }) => {
  return (
    <div className="text-center p-10 bg-white rounded-lg shadow-lg dark:bg-gray-800">
      ...
      <p className="text-lg text-gray-600 dark:text-gray-300">
        {enabled ? 'This feature is under construction.' : 'This feature is currently disabled.'}
      </p>
       <div className="mt-8">
...
export default FeatureStubPage;
